...
type Conversation struct {
	...
	WhoCanSendMessages   PermissionLevel  `db:"who_can_send_messages" json:"who_can_send_messages"`
	WhoCanAddMembers     PermissionLevel  `db:"who_can_add_members" json:"who_can_add_members"`
	WhoCanEditInfo       PermissionLevel  `db:"who_can_edit_info" json:"who_can_edit_info"`
	WhoCanPinMessages    PermissionLevel  `db:"who_can_pin_messages" json:"who_can_pin_messages"`
...
type Message struct {
	...
	FormatType             MessageFormatType `db:"format_type" json:"format_type"`
...
type DeliveryStatus struct {
	...
	MessageID    string             `db:"message_id" json:"message_id"`
	UserID       string             `db:"user_id" json:"user_id"`
	Status       DeliveryStatusType `db:"status" json:"status"`
	DeliveredAt  *time.Time         `db:"delivered_at" json:"delivered_at,omitempty"`
...
type MessageReport struct {
	...
	Priority       ReportPriority `db:"priority" json:"priority"`
