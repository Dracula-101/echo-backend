...
type PresenceHandlerInterface interface {
	...
	GetPresenceHistory(w http.ResponseWriter, r *http.Request)
	...
	UpdateCustomStatus(w http.ResponseWriter, r *http.Request)
	ClearCustomStatus(w http.ResponseWriter, r *http.Request)
}
